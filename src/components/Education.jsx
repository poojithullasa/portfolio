        ...
        <Row>
          ...
          <Col xs={4} md={4}>
            <Card>
              <Card.Img
                variant="top"
                src="https://thumbs.dreamstime.com/b/students-interacting-each-other-making-friends-university-college-campus-tours-university-campus-events-campus-learning-161716781.jpg"
              />
              <Card.Body>
          ...
          <Col xs={4} md={4}>
            <Card>
              <Card.Img
                variant="top"
                src="https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcT_jvbVFYhtEqf171QljkRj_2HEx8XayHA3YQ&usqp=CAU"
              />
              <Card.Body>
